...
- (void)_initView{
    ...
    for (int i = 0; i < 2; i++) {
        ...
        if (i == 0) {
            ...
            UIButton *btn = [UIButton button:CGRectMake(CGRectGetMaxX(cell.frame), CGRectGetMinY(cell.frame), 30, CGRectGetHeight(cell.frame)) title:@""];
    ...
    self.loginBtn = [UIButton button:CGRectMake(gap, CGRectGetMaxY(self.passTF.frame)+30, kScreenWidth-gap*2, 40) title:@"登录"];
    [self.loginBtn tag:0 target:self action:@selector(loginAction:)];
    ...
    UIButton *registBtn = [UIButton button:CGRectMake(gap, CGRectGetMaxY(self.loginBtn.frame)+10, 100, 25) title:@"手机快速注册"];
    
    [registBtn tag:1 target:self action:@selector(_regerstAction)];
    ...
    UIButton *findPassWordBtn = [UIButton button:CGRectMake(kScreenWidth-gap-100, CGRectGetMaxY(self.loginBtn.frame)+10, 100, 25) title:@"忘记密码"];
    [findPassWordBtn tag:2 target:self action:@selector(_findPassWord)];
